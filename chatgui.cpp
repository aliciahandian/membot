    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>();  //use make_unique to return a unique pointer to an object of class ChatLogic
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    //delete _chatLogic;   WE DON'T HAVE TO EXPLICITLY DELETE, THE SMART POINTER DESTRUCTS AT THE END OF SCOPE
